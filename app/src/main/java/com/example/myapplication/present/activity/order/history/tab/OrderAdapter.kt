...
class OrderAdapter(
    ...
    //`feat: thêm OrderAdapter hiển thị danh sách đơn hàng theo trạng thái`
    ...
    //`feat: bổ sung hiển thị dữ liệu và trạng thái thao tác đơn hàng trong OrderAdapter`
    ...
    //`feat: bổ sung xử lý sự kiện thao tác trên từng đơn hàng trong OrderAdapter`
}